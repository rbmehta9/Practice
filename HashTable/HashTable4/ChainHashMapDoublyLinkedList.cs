...
{
    public class ChainHashMapDoublyLinkedList<K, V> : AbstractHashMap<K, V>
    {
        public ChainHashMapDoublyLinkedList(int capacity, int primefactor) : base(capacity, primefactor) { }

        public ChainHashMapDoublyLinkedList(int capacity) : base(capacity) { }

        public ChainHashMapDoublyLinkedList() : base() { }

        private UnSortedMapDoublyLinkedList<K,V>[] _hashTable;
        ...
        {
            private UnSortedMapDoublyLinkedList<K, V> _table;
            public ChainHashMapKVPIterator(UnSortedMapDoublyLinkedList<K, V>[] table)
            {
        ...
        {
            private UnSortedMapDoublyLinkedList<K, V>[] _table;
            public ChainHashMapIterable(UnSortedMapDoublyLinkedList<K, V>[] table)
            {
                _table = table;
            }
        ...
        public override V BucketPut(int h, K key, V value)
        {
            ...
            if (bucket == null)
            {
                bucket = new UnSortedMapDoublyLinkedList<K, V>();
                _hashTable[h] = bucket;
            }
        ...
        {
            _hashTable = new UnSortedMapDoublyLinkedList<K, V>[_capacity];
        }
